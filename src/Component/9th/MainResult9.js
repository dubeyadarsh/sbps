...
const MainResult9 = () => {
  ...
  useEffect(()=>{
      ...
      let x=Number(props.hindi)+Number(props.english)+Number(props.math)+Number(props.sci)+Number(props.ssci)+Number(props.it);
    settotal(x);
    let per=((x/300)*100).toFixed(2);
    setperc(per);
    if(per>=60){
    ...
    <div>
      ...
      <div className="main">
        ...
        <div className="row ro1">
          ...
          <div class="row ro2 mg"><h6>IT </h6></div>
          ...
          <div className="col-5 col-md-5 co1">
             ...
             <div className="col">
                 <div className="row" style={{display:"flex" ,flexDirection:"row"}}>
                  <div style={{width:"20%" }}>50</div>
                  <div style={{width:"20%"}}>{props.it}</div>
                  <div style={{width:"20%"}}></div>
                  <div style={{width:"20%"}}></div>
                  <div style={{width:"20%"}}>{props.it}</div>
              </div>
             ...
             <div className="col">
                 <div className="row" style={{display:"flex" ,flexDirection:"row"}}>
                  <div style={{width:"20%" }}><h6>300</h6></div>
          ...
          <div className="row mg1">
             ...
             <div className="row mg1">
                 ...
                 <div className="row" style={{display:"flex" ,flexDirection:"row"}}>
                  ...
                  <div style={{width:"16.66%"}}></div>
                  <div style={{width:"16.66%"}}>0</div>
                  <div style={{width:"16.66%"}}>{props.it}</div>
              </div>
                 </div>
             </div>
             ...
             <div className="row mg1">
                 <div className="col">
                 <div className="row" style={{display:"flex" ,flexDirection:"row"}}>
                  <div style={{width:"16.66%" }}> <h6>300</h6></div>
                  <div style={{width:"16.66%"}}></div>
                  <div style={{width:"16.66%"}}></div>
                  <div style={{width:"16.66%"}}></div>
                  <div style={{width:"16.66%"}}>0</div>

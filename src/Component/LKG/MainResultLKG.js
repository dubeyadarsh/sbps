...
const MainResultLKG = () => {
  ...
  useEffect(()=>{
      let x=Number(props.hindi)+Number(props.english)+Number(props.math)+Number(props.hindi_o)+Number(props.gk)+Number(props.english_o)+Number(props.math_o)+Number(props.drawing)+Number(props.sports);
    settotal(x);
    ...
    <div>
      ...
      <div className="main">
        ...
        <div className="row ro1">
          ...
          <div class="row ro2 mg"><h6>Drawing </h6> </div>
          ...
          <div className="col-5 col-md-5 co1">
             ...
             <div className="col">
                 <div className="row" style={{display:"flex" ,flexDirection:"row"}}>
                  ...
                  <div style={{width:"20%"}}>{props.drawing}</div>
                  <div style={{width:"20%"}}></div>
                  <div style={{width:"20%"}}></div>
                  <div style={{width:"20%"}}>{props.drawing}</div>
              </div>
          ...
          <div className="row mg1">
             ...
             <div className="row mg1">
                 ...
                 <div className="row" style={{display:"flex" ,flexDirection:"row"}}>
                  ...
                  <div style={{width:"16.66%"}}></div>
                  <div style={{width:"16.66%"}}>0</div>
                  <div style={{width:"16.66%"}}>{props.drawing}</div>
              </div>
                 </div>
             </div>
             <div className="row mg1">

...
import {
 ...
 const ResultLKG = () => {
    ...
    function submit(e){
        e.preventDefault();
        settotal(hindi+english+math+hindi_o+gk+english_o+math_o+drawing+sports);
    }
    ...
    <>
      ...
      <div class="container bg-info">
         <form action=""  onSubmit={submit}>
             ...
             <div class="form">
                <label for="name">G.K.</label>
                <input value={gk}   onChange={(e)=>setgk(e.target.value)} type="number" placeholder="Enter your marks" />    
             </div>
             <div class="form">
                <label for="name">Drawing</label>
                <input value={drawing}   onChange={(e)=>setdrawing(e.target.value)} type="number" placeholder="Enter your marks" />    
             </div>
             <div class="form">
             ...
             <div className="buttn" ><Link  to= "/MainResultLKG" state={{oact:oact, disc:disc,clean:clean,beh:beh,punc:punc ,class:clas, name:name, roll:roll, hindi:hindi, hindi_o:hindi_o, english:english,english_o:english_o,math:math,math_o:math_o,gk:gk,drawing:drawing,sports:sports}} type="submit" className="btn bg-danger">Submit </Link> </div>

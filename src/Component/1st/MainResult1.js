...
const MainResult1 = () => {
  ...
  useEffect(()=>{
      let x=Number(props.hindi)+Number(props.english)+Number(props.math)+Number(props.sci)+Number(props.art)+Number(props.ssci)+Number(props.gk)+Number(props.comp);
    settotal(x);

    ...
    <>
      ...
      <div class="container bg-info">
         <form action=""  onSubmit={submit}>
             ...
             <div className="buttn" ><Link  to= "/MainResult1" state={{oact:oact, disc:disc,clean:clean,beh:beh,punc:punc ,class:clas, name:name, roll:roll, hindi:hindi, english:english,math:math,art:art,comp:comp,sci:sci,ssci:ssci,gk:gk}} type="submit" className="btn bg-danger">Submit </Link> </div>

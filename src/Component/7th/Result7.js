...
import {
 ...
 const Result7 = () => {
    ...
    function submit(e){
        e.preventDefault();
        settotal(hindi+english+math+comp+sci+ssci+gk);
    }
    ...
    <>
      ...
      <div class="container bg-info">
         <form action=""  onSubmit={submit}>
             ...
             <div className="buttn" ><Link  to= "/MainResult7" state={{oact:oact, disc:disc,clean:clean,beh:beh,punc:punc ,class:clas, name:name, roll:roll, hindi:hindi, english:english, grm:grm,math:math,comp:comp,sci:sci,ssci:ssci,gk:gk}} type="submit" className="btn bg-danger">Submit </Link> </div>

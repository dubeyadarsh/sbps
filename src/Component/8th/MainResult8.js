...
const MainResult8 = () => {
  ...
  useEffect(()=>{
      let x=Number(props.hindi)+Number(props.english)+Number(props.math)+Number(props.sci)+Number(props.ssci)+Number(props.gk)+Number(props.comp);
    settotal(x);
    let per=((x/350)*100).toFixed(2);
    setperc(per);
    if(per>=60){
      ...
      <div className="main">
        ...
        <div className="row ro1">
          ...
          <div className="col-5 col-md-5 co1">
             ...
             <div className="col">
                 <div className="row" style={{display:"flex" ,flexDirection:"row"}}>
                  <div style={{width:"20%" }}><h6>350</h6></div>
          ...
          <div className="row mg1">
             ...
             <div className="row mg1">
                 <div className="col">
                 <div className="row" style={{display:"flex" ,flexDirection:"row"}}>
                  <div style={{width:"16.66%" }}> <h6>350</h6></div>
                  <div style={{width:"16.66%"}}></div>
                  <div style={{width:"16.66%"}}></div>
                  <div style={{width:"16.66%"}}></div>
                  <div style={{width:"16.66%"}}>0</div>
